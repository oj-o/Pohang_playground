# Safe Distancing Game - Web Version

이 프로젝트는 Python OpenCV 기반의 세이프 디스턴싱 게임을 웹 브라우저에서 실행할 수 있도록 변환한 것입니다.

## 🎮 게임 설명

세이프 디스턴싱 게임은 플레이어들이 서로 간의 거리를 유지하면서 점수를 얻는 게임입니다. 각 게임 모드마다 다른 최소 거리 요구사항이 있습니다.
